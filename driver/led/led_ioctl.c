...
#define CMD_LED_7				_IOW('L', 0, unsigned long)
#define CMD_LED_8				_IOW('L', 1, unsigned long)
#define CMD_LED_9				_IOW('L', 2, unsigned long)
#define CMD_LED_10				_IOW('L', 3, unsigned long)
